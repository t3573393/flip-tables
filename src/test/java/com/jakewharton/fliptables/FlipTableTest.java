...
public class FlipTableTest {
	...
	public void empty() {
		...
		String expected = "" + "╔══════╤════════╗\n" + "║ Test │ Header ║\n" + "╠══════╧════════╣\n"
				+ "║ (empty)       ║\n" + "╚═══════════════╝\n";
		Assert.assertEquals(FlipTable.of(headers, data), expected);
	}
	...
	public void headerWithColor() {
		...
		String withoutColor = out.replace("\u001b[31m", "").replace("\u001b[0m", "").replace("\u001b[34m", "")
				.replace("\u001b[0m", "").replace("\u001b[93m", "").replace("\u001b[0m", "");
		Assert.assertEquals(withoutColor, expected);
	}
	...
	public void nested() {
		...
		String expected = "" + "╔═══════════════╤═══════════════╗\n" + "║ Left          │ Right         ║\n"
				...
				+ "║ ║ 1   │ 2   ║ │ ║ 1   │ 2   ║ ║\n" + "║ ╚═════╧═════╝ │ ╚═════╧═════╝ ║\n"
				+ "╚═══════════════╧═══════════════╝\n";
		Assert.assertEquals(FlipTable.of(outerHeaders, outerData), expected);
	}
